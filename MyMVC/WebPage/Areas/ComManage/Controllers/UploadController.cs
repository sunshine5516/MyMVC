...
namespace WebPage.Areas.ComManage.Controllers
{
    public class UploadController : BaseController
    {
        ...
        public ActionResult Home(string fileExt)
        {
        ...
        "html"
            ...
            List<string> list = (
                from p in ConfigurationManager.AppSettings["AttachExtension"].Trim(new char[]
                {
            ','
                }).Split(new string[]
                {
        ...
        // WebPage.Areas.ComManage.Controllers.UploadController
        ...
        {
            List<string> list = (
                from p in ConfigurationManager.AppSettings["Document"].Trim(new char[]
                {
            ','
                }).Split(new string[]
                {
        ...
        private string GetUpLoadPath(string _fileExt)
        {
            ...
            {
                // text = text + base.CurrentUser.PinYin + "/";
            }
            string text2 = text;
